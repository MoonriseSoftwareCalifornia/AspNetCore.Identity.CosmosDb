...
namespace AspNetCore.Identity.CosmosDbSqlServerStore.Tests
{
    public class TestUtilities
    {
        ...
        {                       
            var dbContext =
                new CosmosIdentityDbContext<IdentityUser, IdentityRole, string>(GetDbOptions(connectionString));
            return dbContext;
        }
        ...
        /// <param name="connectionName"></param>
        /// <returns></returns>
        public CosmosUserStore<IdentityUser, IdentityRole, string> GetUserStore(string connectionString)
        {
            var repository =
        ...
        /// </summary>
        /// <returns></returns>
        public CosmosRoleStore<IdentityUser, IdentityRole, string> GetRoleStore(string connectionString)
        {
            var repository =
                new CosmosIdentityRepository<CosmosIdentityDbContext<IdentityUser, IdentityRole, string>, IdentityUser,
                    IdentityRole, string>(GetDbContext(connectionString));
        ...
        /// </summary>
        /// <returns></returns>
        public RoleManager<IdentityRole> GetRoleManager(string connectionString)
        {
